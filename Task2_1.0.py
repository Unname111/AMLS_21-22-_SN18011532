...
class CNNmodel(nn.Module):
    def __init__(self):
        ...
        # Try with some randome number and get the error
...
loss_list = []
accuracy_record = []
for epoch in range(50):  # should be 10, but for faster test this is set to 5 while coding
    flag = []
...
"""
Uncommon this block to use the model to test new images
